...
const saveConsumerCheck = async(request) =>{
      try{
        ...
        // if (
        //   request.num_retries < 1 ||
        //   request.num_retries > 5 ||
        //   request.uptime_sla < 0 ||
        //   request.uptime_sla > 100 ||
        //   request.response_time_sla < 0 ||
        //   request.response_time_sla > 100 ||
        //   request.check_interval_in_seconds < 1 ||
        //   request.check_interval_in_seconds > 86400
        // ) {
        //   throw new Error();
        // }
